            ...
            <Tab.Navigator initialRouteName='Home' tabBarOptions={{
                ...
                <Tab.Screen name='Home' component={Home} options={{
                    tabBarIcon: ({ color }) => (<Image
                        source={require('../assets/icons/navigation/icon-home.png')}
                        style={[Styles.icon, { tintColor: color }]}
                    />)
                }} />
                <Tab.Screen name='Notifications' component={Notifications} options={{
                    tabBarIcon: ({ color }) => (<Image
                        source={require('../assets/icons/navigation/icon-notifications.png')}
                        style={[Styles.icon, { tintColor: color }]}
                    />)
                }} />
                ...
                <Tab.Screen name='Chat' component={Chat} options={{
                    tabBarIcon: ({ color }) => (<Image
                        source={require('../assets/icons/navigation/icon-chat.png')}
                        style={[Styles.icon, { tintColor: color }]}
                    />)
                }} />
                <Tab.Screen name='Profile' component={Profile} options={{
                    tabBarIcon: ({ color }) => (<Image
                        source={require('../assets/icons/navigation/icon-profile.png')}
                        style={[Styles.icon, { tintColor: color }]}
                    />)
                }} />
            </Tab.Navigator>
